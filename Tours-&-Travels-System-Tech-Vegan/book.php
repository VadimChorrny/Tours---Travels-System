	...
	<div align="center"> <span class="subHead">Book Holiday Package</span> <br />
		...
		<form method="post" action="">
			<table border="0" cellpadding="5" cellspacing="5" class="design">
				<tr>
					<td colspan="2" align="center" class="info"><?php echo $info; ?></td>
				</tr>
				<tr>
					<td class="labels">Package : </td>
					<td>
				...
				<tr>
					<td class="labels">Members : </td>
					<td><input type="number" class="fields" size="5" placeholder="Select Members" required="required" name="mem" /></td>
				</tr>
				<tr>
					<td class="labels">Date : </td>
					<td><input type="date" class="fields" size="10" placeholder="DD/MM/YYY" required="required" name="d" /></td>
				</tr>

				<tr>
					<td colspan="2" align="center"><input type="submit" value="BOOK NOW" class="fields" /></td>
				</tr>
			</table>
		</form>
		<br />
		...
		<table border="0" cellpadding="5" cellspacing="5" class="design ashu">
			...
			?>
				<tr class="labels">
					...
					<td class="ashu"><?php if ($y['status'] == 1) {
											echo "Approved";
										} else {
											echo "Pending";
										} ?></td>
